...
function girq (a)
{
	let obj{girq1:{hexinak:"Francis Scott Key Fitzgerald",vernagir:"Tender Is the Night",kch:false}, girq2:{hexinak:"Կուրտ Վոնեգութ",vernagir:"Մարտ համար հինգ ",kch:false} , girq3:{hexinak:" Ջորջ Օրուել ",vernagir:"1984",kch:true}} ;                        
	if(a = true)
	{
		if(obj[kch] === true)
		{
